...
test_router = APIRouter(prefix="/api/v1", tags=["identity"])
...
@test_router.post("/identity/test-session", response_model=SessionResponse)
...
@test_router.post("/identity/test-reset", response_model=TestResetResponse)
